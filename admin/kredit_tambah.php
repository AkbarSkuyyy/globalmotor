...
<body>
    ...
    <div class="container mt-4 mb-5" style="max-width: 1000px;">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <button type="button" onclick="window.history.back()" class="btn btn-outline-secondary rounded-pill px-4">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-6">
                    <div class="card shadow-sm border-0 rounded-4 h-100 p-4 bg-white">
                        <div class="section-title">
                            <i class="bi bi-person-lines-fill me-2 text-primary"></i> Data Nasabah
                        </div>
                ...
                <div class="col-12">
                    <div class="card shadow-sm border-0 rounded-4 p-4 bg-white">
                        <div class="section-title">
                            <i class="bi bi-file-earmark-spreadsheet-fill me-2 text-primary"></i> Rincian Kredit
                        </div>
                        ...
                        <div class="mt-4 pt-3 border-top text-end">
                            <button type="submit" class="btn btn-primary rounded-pill px-5 fw-bold py-2 shadow-sm">
                                <i class="bi bi-save-fill me-2"></i> Simpan Kontrak Kredit
                            </button>
                        </div>
                    </div>
                </div>
